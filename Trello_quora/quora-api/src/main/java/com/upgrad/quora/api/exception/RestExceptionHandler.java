...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> signUpException(SignUpRestrictedException exe) {
    ...
    public ResponseEntity<ErrorResponse> singOutException(SignOutRestrictedException exe) {
        return new ResponseEntity<ErrorResponse>(
